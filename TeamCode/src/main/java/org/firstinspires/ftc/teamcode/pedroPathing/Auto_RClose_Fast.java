...
public class Auto_RClose_Fast extends OpMode {
        ...
        org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState pathState;
        ...
        private final Pose preloadpose = new Pose(99.52891396332863, 80.90973201692523, Math.toRadians(355));
        private final Pose load = new Pose(135.88011283497883, 80.68406205923836, Math.toRadians(355));
        private final Pose shoot2 = new Pose(102.52609308885754, 101.81241184767278, Math.toRadians(42));
        private final Pose preload2 = new Pose(99.7771509167842, 50.35966149506348, Math.toRadians(352));
        private final Pose load2 = new Pose(135.91396332863187, 50.16784203102963, Math.toRadians(352));
        private final Pose shoot3 = new Pose(102.55994358251058, 107.51480959097319, Math.toRadians(42));
        private final Pose preload3 = new Pose(99.78984485190409, 22.78843441466854, Math.toRadians(352));
        private final Pose load3 = new Pose(135.91396332863187, 22.31452750352609, Math.toRadians(352));
        ...
        public void statePathUpdate() {
            switch (pathState) {
                case drive_start_shoot:
                    ...
                    setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot);
                    break;
                ...
                case shoot:
                    if (!follower.isBusy()) {
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            ...
                            setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot_preload);
                        }
                    }
                    break;
                ...
                case shoot_preload:
                    if (!follower.isBusy() && getRuntime() - stateStartTime > 3) {
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.preload_load);
                ...
                case preload_load:
                    if(!follower.isBusy()){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.load_shoot);
                    }
                    break;
                ...
                case load_shoot:
                    if(!follower.isBusy()){
                        intake(0, 0);
                        follower.setMaxPower(0.85);                        follower.followPath(loadShoot1, true);
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot2);
                    }
                    break;
                ...
                case shoot2:
                    if(!follower.isBusy()){
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            intake(1, 1);
                            setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot_preload2);
                        }
                    }
                    break;
                ...
                case shoot_preload2:
                    if(!follower.isBusy()&& getRuntime() - stateStartTime > 3){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.preload_load2);
                ...
                case preload_load2:
                    if(!follower.isBusy()){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.load_shoot2);
                    }
                    break;
                case load_shoot2:
                    if(!follower.isBusy()){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot3);
                    }
                    break;
                ...
                case shoot3:
                    if(!follower.isBusy()){
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            intake(1, 1);
                            setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot_preload3);
                        }
                    }
                    break;
                ...
                case shoot_preload3:
                    if(!follower.isBusy() && getRuntime() - stateStartTime > 3){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.preload_load3);
                ...
                case preload_load3:
                    if(!follower.isBusy()){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.load_shoot3);
                    }
                    break;
                ...
                case load_shoot3:
                    if(!follower.isBusy()){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot4);
                    }
                    break;
                ...
                case shoot4:
                    if(!follower.isBusy()){
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            intake(1, 1);
                            setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.shoot_final);
                        }
                    }
                    break;
                ...
                case shoot_final:
                    if(!follower.isBusy() && getRuntime() - stateStartTime > 3){
                        ...
                        setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.Default);
                    }
                    break;
        ...
        public void setPathState(org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState newState) {
            pathState = newState;
        ...
        @Override
        public void init() {
            pathState = org.firstinspires.ftc.teamcode.pedroPathing.Auto_RClose.PathState.drive_start_shoot;
            pathTimer = new Timer();
