...
public class Auto_BClose_ZTest extends OpMode {
    ...
    private final Pose load = new Pose(12.119887165021163, 83.68406205923836, Math.toRadians(180));
    ...
    private final Pose load2 = new Pose(11.983074753173506, 59.16784203102963, Math.toRadians(180));
    ...
    private final Pose load3 = new Pose(12.086036671368124, 35.31452750352609, Math.toRadians(180));
    private final Pose shoot4 = new Pose(43.626234132581104, 99.63187588152329, Math.toRadians(140));
    private final Pose finalPos = new Pose(51.286318758815234, 108.25811001410436, Math.toRadians(140));
