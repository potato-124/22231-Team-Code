...
@Autonomous
public class Auto_RFar extends OpMode {
    ...
    PathState pathState;
    private final Pose startshootpose = new Pose(83.18245495540236,11.811756292337966, Math.toRadians(60));
    private final Pose preload = new Pose(83.38410377639602,35.24402550706212, Math.toRadians(0));
    private final Pose load = new Pose(137.70140845070424,35.6169014084507,Math.toRadians(0));
    private final Pose shoot = new Pose(83.15211278351259,11.763380281690141, Math.toRadians(60));
    private final Pose preload2 = new Pose(83.4676056338028,60.3492957746479, Math.toRadians(0));
    private final Pose load2 = new Pose(137.82535211267606,59.91830985915493, Math.toRadians(0));
    private final Pose shoot2 = new Pose(83.2225352112676,11.881690140845063, Math.toRadians(60));
    private final Pose preload3 = new Pose(83.89014084507042,83.96901408450702, Math.toRadians(0));
    private final Pose load3 = new Pose(137.18873239436618,84.11830985915492, Math.toRadians(0));
    private final Pose shoot3 = new Pose(83.38873239436619,11.97183098591549, Math.toRadians(60));
        ...
        switch (pathState){
            case shoot:
                if(!follower.isBusy() ){
                    ...
                    if (Math.abs(1800 - Potato1.getVelocity()) < 10) {
                        intake(1, 1);
