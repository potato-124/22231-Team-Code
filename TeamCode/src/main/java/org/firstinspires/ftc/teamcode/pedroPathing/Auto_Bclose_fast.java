...
@Autonomous
public class Auto_Bclose_fast extends OpMode {
        ...
        Auto_BClose.PathState pathState;
        ...
        public void statePathUpdate() {
            switch (pathState) {
                case drive_start_shoot:
                    ...
                    setPathState(Auto_BClose.PathState.shoot);
                    break;
                ...
                case shoot:
                    if (!follower.isBusy()) {
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            ...
                            setPathState(Auto_BClose.PathState.shoot_preload);
                        }
                    }
                    break;
                ...
                case shoot_preload:
                    if(!follower.isBusy() && getRuntime() - stateStartTime > 3) {
                        ...
                        setPathState(Auto_BClose.PathState.preload_load);
                ...
                case preload_load:
                    if(!follower.isBusy()){
                        ...
                        setPathState(Auto_BClose.PathState.load_shoot);
                    }
                    break;
                ...
                case load_shoot:
                    if(!follower.isBusy()){
                        ...
                        setPathState(Auto_BClose.PathState.shoot2);
                    }
                    break;
                ...
                case shoot2:
                    if(!follower.isBusy() ){
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            intake(1, 1);
                            setPathState(Auto_BClose.PathState.shoot_preload2);
                        }
                    }
                    break;
                ...
                case shoot_preload2:
                    if(!follower.isBusy() && getRuntime() - stateStartTime > 3){
                        ...
                        setPathState(Auto_BClose.PathState.preload_load2);
                ...
                case preload_load2:
                    if(!follower.isBusy()){
                        ...
                        setPathState(Auto_BClose.PathState.load2_loadadjust);
                    }
                    break;
                case load2_loadadjust:
                    if(!follower.isBusy()){
                        ...
                        setPathState(Auto_BClose.PathState.load_shoot2);
                    }
                case load_shoot2:
                    if(!follower.isBusy()){
                        intake(0, 0);
                        ...
                        setPathState(Auto_BClose.PathState.shoot3);
                    }
                    break;
                ...
                case shoot3:
                    if(!follower.isBusy()){
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            intake(1, 1);
                            setPathState(Auto_BClose.PathState.shoot_preload3);
                        }
                    }
                    break;
                ...
                case shoot_preload3:
                    if(!follower.isBusy() && getRuntime() - stateStartTime > 3){
                        ...
                        setPathState(Auto_BClose.PathState.preload_load3);
                ...
                case preload_load3:
                    if(!follower.isBusy()){
                        ...
                        setPathState(Auto_BClose.PathState.load_shoot3);
                    }
                    break;
                ...
                case load_shoot3:
                    if(!follower.isBusy()){
                        ...
                        setPathState(Auto_BClose.PathState.shoot4);
                    }
                    break;
                ...
                case shoot4:
                    if(!follower.isBusy() ){
                        ...
                        if (Math.abs(1300 - Potato1.getVelocity()) < 10) {
                            intake(1, 1);
                            setPathState(Auto_BClose.PathState.shoot_final);
                        }
                    }
                    break;
                ...
                case shoot_final:
                    if(!follower.isBusy() && getRuntime() - stateStartTime > 3){
                        ...
                        setPathState(Auto_BClose.PathState.Default);
                    }
                    break;
        ...
        public void setPathState(Auto_BClose.PathState newState) {
            pathState = newState;
        ...
        @Override
        public void init() {
            pathState = Auto_BClose.PathState.drive_start_shoot;
            pathTimer = new Timer();
